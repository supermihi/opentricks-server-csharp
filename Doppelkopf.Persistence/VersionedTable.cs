...
public record VersionedTable(Session? Table, int Version)
{
    ...
    public (VersionedTable, TableAction<InitTable>) Init(
    ...
    public (VersionedTable, TableAction<Declare>) Declare(Seat seat, IContract contract) =>
      ...
      where T : ITableActionPayload
    {
        ...
        var nextTable = payload switch
        {
            ...
            Declare dec => Table.Declare(dec.Seat, dec.Contract),
