...
public sealed record Auction : IAuction
{
  private readonly IPlayersCards _cards;
  ...
  public Auction(IPlayersCards cards, IByPlayer<bool> needsCompulsorySolo, InTurns<Declaration> initialState)
  {
    _cards = cards;
  ...
  public Auction(IPlayersCards cards, IByPlayer<bool> needsCompulsorySolo) : this(
    cards,
    needsCompulsorySolo,
    InitialState)
  { }
  ...
  private int Score(Declaration declaration, Player player) =>
      declaration.Contract switch
      {
        ...
        _ => throw new ArgumentOutOfRangeException(nameof(declaration), "unsupported declaration type")
      };
}
