...
public sealed record ByPlayer<T> : IEnumerable<T>
{
  private readonly ImmutableArray<T> _values;

  public ByPlayer(T player1, T player2, T player3, T player4) : this(
    ImmutableArray.Create(player1, player2, player3, player4))
  { }
