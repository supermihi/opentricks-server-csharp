...
public static class Err
{
  ...
  {
    protected InputException Create(string code, string message) => new(Component, Action, code, message);
    ...
    public InputException SeatPaused => Create("seat_paused", "you do not participate in the current game");
  }
  ...
  public static class Auction
  {
    ...
    {
      public InputException NotReserved => Create("not_reserved", "cannot declare without having reserved");
  ...
  public static class TrickTaking
  {
    ...
    {
      public InputException Forbidden => Create("forbidden_card", "the card is forbidden, choose another one");
