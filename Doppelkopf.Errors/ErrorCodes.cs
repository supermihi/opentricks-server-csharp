...
public static class ErrorCodes
{
  ...
  public static readonly ErrorCode InvalidPhase = new(
    "invalid_phase",
    "the specified action is not valid in the current phase of the game");
  ...
  public static readonly ErrorCode ContractNotAllowed = new(
    "contract_not_allowed",
    "the selected contract is not allowed with your cards");
